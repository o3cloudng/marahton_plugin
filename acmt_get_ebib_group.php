...
// exit;
        $curl = curl_init();
        // Local machine url
        // $url = 'http://5.101.138.142:8980/api/barcode/group';

        // Live Server url
        $url = 'http://192.168.1.142:8980/api/barcode/group';
...
add_shortcode('acmt_ebib_group', 'acmt_get_ebib_group');