...
function acmt_reg_single_users_shortcode()
{
    ...
    <?php 
    $response = getRegisteredUsers('single');
...
add_shortcode('acmt_reg_single_users_shortcode', 'acmt_reg_single_users_shortcode');
?>