...
function acmt_complete_registered_users_shortcode()
{
    ...
    <?php 
    $response = getRegisteredUsers('users');
...
add_shortcode('acmt_complete_registered_users_shortcode', 'acmt_complete_registered_users_shortcode');
?>