...
function acmt_family_registration2()
{
    if(!is_user_logged_in()) {
        wp_redirect(site_url('choose-your-registration-type'));
    }
    registrationConfirmation();
    include('templates/family/acmt_family_registration_form2.php');
}
add_shortcode('acmt_family_registration_shortcode2', 'acmt_family_registration2');



add_action('init', 'acmt_family_register2');

function acmt_family_register2()
{
    if (isset($_POST['acmt_family_group_register2'])){
...
// echo $query;
        ...
        if ($result == false) {
            ...
            // header('location:'.site_url("family-payment").');
