...
<div class="container mt-0 pt-0">
        ...
        <form>
            <div class="col-md-8 offset-md-2 text-center">
                <h2>Group Payment</h2>
                <p>Complete your registration by making payment in <strong>Naira</strong>.</p>
                <strong>NB: A discount of NGN5,000 applies for a group of Five (5) </strong>
                <strong>Total cost NGN 20,000 <stike>NGN25,000</stike> </strong>
                <!-- <p>Early bird discount <strong>NGN 3,500 / <strike>NGN 5000</strike></strong>.</p> -->
                ...
                <p><span id="form_error" class="text-danger"></span></p>
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            <!-- <input name="amount" disabled value="17500" class="form-control" />
                            <input type="hidden" name="amount" value="17500" class="form-control" /> -->
                            <input type="text"id="amount_value" disabled value="20,000" class="form-control" />
                ...
                <div class="form-group">
                    <!-- <input style="margin: 0px auto;" onClick="payWithRave()" value="Complete Payment" class="btn btn-primary btn-large btn-block" type="submit" > -->
...
fetch('http://ip-api.com/json')
  ...
  .then(function(loc) {
    ...
    if (location == '"Nigeria"') {
        document.getElementById("amount_value").value = "USD 500"; 
    } else {    
