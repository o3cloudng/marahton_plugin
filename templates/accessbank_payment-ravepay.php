...
//     echo '<script type="text/javascript" src="https://ravesandboxapi.flutterwave.com/flwv3-pug/getpaidx/api/flwpbf-inline.js"></script>';
// }else {
//    echo '<script type="text/javascript" src="https://api.ravepay.co/flwv3-pug/getpaidx/api/flwpbf-inline.js"></script>';
// }
...
// const locData = async () => {
//   const api_loc_call = await fetch(`http://ip-api.com/json`);

//   const loc = await api_loc_call.json();
//   return { loc }
// };
...
// A PHP fucntion to insert acmt_tx reference before going to payment gateway
// I will be running it in javascript
// function acmt_add_user($reference,$pay_amount, $race) {
//     $transaction = [
//         'status' => 'pending',
//         'reference' => $reference,
//         'amount' => $pay_amount,
