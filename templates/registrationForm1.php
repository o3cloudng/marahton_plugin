        ...
        <form method="post" action="" name="acmt_form1" onsubmit="return checkform(this);">
            ...
            <form method="post" action="">
                ...
                <div class="row">
                    <div class="col-sm-12 col-md-6 offset-md-3">
                        <div class="form-group">
                            <input type="submit" disabled id="submit" name="acmt_register" class="btn btn-primary btn-large btn-block align-center w-100"
                                value="Save and Continue" />
                        </div>
                    </div>
                </div>
                        <!-- <div class="form-group">
                            <input type="submit" id="sendbtn" name="acmt_register" class="btn btn-primary btn-large btn-block" value="Save and Continue" />
                        </div> -->
