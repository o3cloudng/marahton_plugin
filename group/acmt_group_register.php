...
function acmt_group_register_form()
{
    if(is_user_logged_in()) {
        wp_redirect(site_url('my-account'));
    }
    include('templates/group_participants/group_register_form.php');
}
add_shortcode('acmt_group_form', 'acmt_group_register_form');



add_action('init', 'acmt_group_register_submit1');

function acmt_group_register_submit1()
{
    if (isset($_POST['acmt_group_register_submit'])) {
