...
function acmt_wheelchair_registration_shortcode()
{
    if(is_user_logged_in()) {
        // wp_redirect(site_url('profile'));
    }
    include('templates/wheelchair/wheelchair_registration.php');
}
add_shortcode('acmt_wheelchair_registration_shortcode', 'acmt_wheelchair_registration_shortcode');



add_action('init', 'acmt_wheelchair_registration');

function acmt_wheelchair_registration()
{
    if (isset($_POST['acmt_wheelchair_registration'])) {
        ...
        if ($register_user) {
            ...
            wp_redirect(site_url('wheel-chair-details/'));
