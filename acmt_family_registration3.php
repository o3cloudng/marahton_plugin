...
function acmt_family_registration3()
{
    if(!is_user_logged_in()) {
        wp_redirect(site_url('choose-your-registration-type'));
    }
    include('templates/family/acmt_family_registration_form3.php');
}
add_shortcode('acmt_family_registration_shortcode3', 'acmt_family_registration3');



add_action('init', 'acmt_family_register3');

function acmt_family_register3()
{
