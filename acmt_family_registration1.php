...
function acmt_family_registration()
{
    if(is_user_logged_in()) {
        wp_redirect(site_url('profile'));
    }
    include('templates/family/acmt_family_registration_form.php');
}
add_shortcode('acmt_family_registration_shortcode', 'acmt_family_registration');



add_action('init', 'acmt_family_register');

function acmt_family_register()
{
    if (isset($_POST['acmt_family_group_register'])) {
        ...
        if ($register_user) {
            ...
            wp_redirect(site_url('family-members/'));
